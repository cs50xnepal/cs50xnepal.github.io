	...
	return (
		<>
			<div
				...
				<div className="relative z-10 text-white text-2xl py-12">
					<div className="justify-center flex flex-col items-center gap-6">
						...
						<Link
							...
							className="bg-primaryRed text-offWhite px-6 py-3 rounded-lg font-semibold text-lg shadow-md hover:bg-red-800 focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-all">
							Register Now 🚀
						</Link>
					</div>
				</div>
