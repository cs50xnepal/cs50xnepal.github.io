	...
	return (
		isOpen && (
			<div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
				<div className="relative w-11/12 max-w-md p-8 rounded-xl shadow-2xl bg-violet-800 text-white">
					{/* Close Button */}
					<button
						onClick={closePopup}
					...
					<div className="text-center">
						<h2 className="text-3xl font-extrabold mb-4">Registration Open!</h2>
						...
						<div className="text-left bg-white bg-opacity-20 rounded-lg p-4 mb-6">
							<p className="font-medium">
								📅 <strong>Start Date:</strong> 22 December 2024
							</p>
							<p className="font-medium">
								🗓️ <strong>Duration:</strong> Six weeks
							</p>
							<p className="font-medium">
								📍 <strong>Venue:</strong> Purwanchal Campus, Dharan
							</p>
						</div>
						<Link
